        ...
        <div className='container'>
            {
                ...
                <>
                    <AdminMenu></AdminMenu>
                    <h5>Total Unapproved: {providers.filter(provider => provider.status === 'Unapproved').length} Providers</h5>
                    <div className='my-2'>
                    ...
                    <Table striped bordered hover>
                        ...
                        <tbody>
                            {
                                providers.map(provider => provider.status === 'Unapproved' &&
                                    <tr>
                                        <td>-</td>
